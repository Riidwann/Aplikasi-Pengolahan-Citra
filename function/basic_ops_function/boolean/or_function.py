...
def boolean_or(image_label, image_result_label, result_text_label):
  ...
  try:
    ...
    # Eksekusi operasi Boolean OR (Lighter)
    result_img = ImageChops.lighter(img_a_rgb, img_b_rgb)
    ...
    result_text_label.config(text="Hasil Operasi OR")

  except Exception as e:
      # Penanganan eksepsi proses
      messagebox.showerror("Error", f"Gagal melakukan OR: {e}")